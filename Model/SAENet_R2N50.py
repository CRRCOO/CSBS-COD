...
class SAENet(nn.Module):
    ...
    def __init__(self, channel=64):
        ...
        self.encoder = Res2Net50(pretrain=True)
        self.ppm = PPM(in_channels=channel, out_channels=channel)
        # reduction
        self.re_conv1 = ConvBNReLU(in_channels=256, out_channels=channel, kernel_size=3)
        self.re_conv2 = ConvBNReLU(in_channels=512, out_channels=channel, kernel_size=3)
        self.re_conv3 = ConvBNReLU(in_channels=1024, out_channels=channel, kernel_size=3)
        self.re_conv4 = ConvBNReLU(in_channels=2048, out_channels=channel, kernel_size=3)
